...
type GatewayConfig struct {
	...
	// ForceOpenAIImagesResponses: 是否强制 OpenAI OAuth 图片请求走 Responses 兼容端点，跳过原生 Codex Images 端点。
	// 默认关闭；可由管理端 Codex 设置覆盖。
	ForceOpenAIImagesResponses bool `mapstructure:"force_openai_images_responses"`
...
func setDefaults() {
	...
	viper.SetDefault("gateway.force_openai_images_responses", false)
